...
replace (
	...
	k8s.io/api => github.com/hkwan003/kubernetes/staging/src/k8s.io/api v1.35.0-k3s3-cert16yr
	k8s.io/apiextensions-apiserver => github.com/hkwan003/kubernetes/staging/src/k8s.io/apiextensions-apiserver v1.35.0-k3s3-cert16yr
	k8s.io/apimachinery => github.com/hkwan003/kubernetes/staging/src/k8s.io/apimachinery v1.35.0-k3s3-cert16yr
	k8s.io/apiserver => github.com/hkwan003/kubernetes/staging/src/k8s.io/apiserver v1.35.0-k3s3-cert16yr
	k8s.io/cli-runtime => github.com/hkwan003/kubernetes/staging/src/k8s.io/cli-runtime v1.35.0-k3s3-cert16yr
	k8s.io/client-go => github.com/hkwan003/kubernetes/staging/src/k8s.io/client-go v1.35.0-k3s3-cert16yr
	k8s.io/cloud-provider => github.com/hkwan003/kubernetes/staging/src/k8s.io/cloud-provider v1.35.0-k3s3-cert16yr
	k8s.io/cluster-bootstrap => github.com/hkwan003/kubernetes/staging/src/k8s.io/cluster-bootstrap v1.35.0-k3s3-cert16yr
	k8s.io/code-generator => github.com/hkwan003/kubernetes/staging/src/k8s.io/code-generator v1.35.0-k3s3-cert16yr
	k8s.io/component-base => github.com/hkwan003/kubernetes/staging/src/k8s.io/component-base v1.35.0-k3s3-cert16yr
	k8s.io/component-helpers => github.com/hkwan003/kubernetes/staging/src/k8s.io/component-helpers v1.35.0-k3s3-cert16yr
	k8s.io/controller-manager => github.com/hkwan003/kubernetes/staging/src/k8s.io/controller-manager v1.35.0-k3s3-cert16yr
	k8s.io/cri-api => github.com/hkwan003/kubernetes/staging/src/k8s.io/cri-api v1.35.0-k3s3-cert16yr
	k8s.io/cri-client => github.com/hkwan003/kubernetes/staging/src/k8s.io/cri-client v1.35.0-k3s3-cert16yr
	k8s.io/csi-translation-lib => github.com/hkwan003/kubernetes/staging/src/k8s.io/csi-translation-lib v1.35.0-k3s3-cert16yr
	k8s.io/dynamic-resource-allocation => github.com/hkwan003/kubernetes/staging/src/k8s.io/dynamic-resource-allocation v1.35.0-k3s3-cert16yr
	k8s.io/endpointslice => github.com/hkwan003/kubernetes/staging/src/k8s.io/endpointslice v1.35.0-k3s3-cert16yr
	k8s.io/externaljwt => github.com/hkwan003/kubernetes/staging/src/k8s.io/externaljwt v1.35.0-k3s3-cert16yr
	...
	k8s.io/kms => github.com/hkwan003/kubernetes/staging/src/k8s.io/kms v1.35.0-k3s3-cert16yr
	k8s.io/kube-aggregator => github.com/hkwan003/kubernetes/staging/src/k8s.io/kube-aggregator v1.35.0-k3s3-cert16yr
	k8s.io/kube-controller-manager => github.com/hkwan003/kubernetes/staging/src/k8s.io/kube-controller-manager v1.35.0-k3s3-cert16yr
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20250910181357-589584f1c912
	k8s.io/kube-proxy => github.com/hkwan003/kubernetes/staging/src/k8s.io/kube-proxy v1.35.0-k3s3-cert16yr
	k8s.io/kube-scheduler => github.com/hkwan003/kubernetes/staging/src/k8s.io/kube-scheduler v1.35.0-k3s3-cert16yr
	k8s.io/kubectl => github.com/hkwan003/kubernetes/staging/src/k8s.io/kubectl v1.35.0-k3s3-cert16yr
	k8s.io/kubelet => github.com/hkwan003/kubernetes/staging/src/k8s.io/kubelet v1.35.0-k3s3-cert16yr
	k8s.io/kubernetes => github.com/k3s-io/kubernetes v1.35.0-k3s3-cert16yr
	k8s.io/metrics => github.com/hkwan003/kubernetes/staging/src/k8s.io/metrics v1.35.0-k3s3-cert16yr
	k8s.io/mount-utils => github.com/hkwan003/kubernetes/staging/src/k8s.io/mount-utils v1.35.0-k3s3-cert16yr
	k8s.io/node-api => github.com/hkwan003/kubernetes/staging/src/k8s.io/node-api v1.35.0-k3s3-cert16yr
	k8s.io/pod-security-admission => github.com/hkwan003/kubernetes/staging/src/k8s.io/pod-security-admission v1.35.0-k3s3-cert16yr
	k8s.io/sample-apiserver => github.com/hkwan003/kubernetes/staging/src/k8s.io/sample-apiserver v1.35.0-k3s3-cert16yr
	k8s.io/sample-cli-plugin => github.com/hkwan003/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.35.0-k3s3-cert16yr
	k8s.io/sample-controller => github.com/hkwan003/kubernetes/staging/src/k8s.io/sample-controller v1.35.0-k3s3-cert16yr
